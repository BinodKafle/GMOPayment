"""
Django settings for GMOPayment project.
...
SECRET_KEY = "django-insecure-4^t5!d%vfz^9gdgt9i0z01$dnl##3oef1eirpu3ju4a8*y#1_1"
...
WSGI_APPLICATION = "GMOPayment.wsgi.application"
...
GMO_PAYMENT = {
    ...
    "pm_token_public_key": config("PM_TOKEN_PUBLIC_KEY"),
    "pm_token_api_key": config("PM_TOKEN_API_KEY"),
}
